...
I decided to make something a bit more interesting: heating sugar until only the carbon remains ([example here](https://www.youtube.com/shorts/suPJLs1xx9o)). The result looks more regular, is pure black, and is even cheaper if you have sugar and a kitchen stove.  
...
Another experiment I'd like to try is levitating the sample using an array of opposing magnets ([like this](https://www.youtube.com/watch?v=8xPLKWxhRu0)).
